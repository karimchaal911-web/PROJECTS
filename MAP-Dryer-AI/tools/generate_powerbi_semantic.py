...
RELATIONSHIP_BLOCK = """/// ===== BEGIN 5S EXTENSION (generated) =====
relationship events-to-contributors
...
def main() -> None:
    ...
    relationships = RELATIONSHIPS_TMDL.read_text(encoding="utf-8")
    relationships = replace_block(
        relationships,
        RELATIONSHIP_BLOCK,
