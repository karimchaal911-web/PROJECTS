...
- `POWERBI DASHBOARD/sql/upgrade_5s_schema.sql` — versioned-stream filtering,
  partial index, lab/event cleanup, lightweight trend view.
- `POWERBI DASHBOARD/sql/create_powerbi_views.sql` — marked explicitly as
...
- `README.md` and `POWERBI DASHBOARD/README.md` — supported service, refresh,
...
The pre-existing deletion of `POWERBI DASHBOARD/gi.pbix` and the pre-existing
