...
2. ``powerbi_dashboard/sql/bootstrap_base_schema.sql`` — base tables,
   upsert functions and compatibility views (idempotent);
3. ``powerbi_dashboard/sql/upgrade_5s_schema.sql`` — the 5-second
...
SQL_DIR = PROJECT_ROOT / "powerbi_dashboard" / "sql"
