...
const JOBS = [
  ['powerbi_dashboard/preview/preview_page1_overview.html', 'powerbi_overview.png'],
  ['powerbi_dashboard/preview/preview_page2_diagnostics.html', 'powerbi_diagnostics.png'],
];
