...
3. INTEGRITY — the model artifacts on disk still hash to the values recorded in
  ...
  python final_presentation/data_build/qa_checks.py
"""
...
def check_deliverables() -> None:
    ...
    expect = [
        ...
        ("PDF fallback", PRES / "FINAL_MAP_Soluble_Digitalization_Soutenance.pdf"),
        ("PPTX fallback", PRES / "FINAL_MAP_Soluble_Digitalization_Soutenance.pptx"),
        ("MP4 backup", PRES / "FINAL_MAP_Soluble_Digitalization_Soutenance_Backup.mp4"),
